...
This example shows how to use the AESCTR driver. The target expects the user
...
It performs an encryption on a predefined message using `AESCTR_oneStepEncrypt`
and displays the encrypted message to the console. Then, it performs a decryption
using `AESCTR_oneStepDecrypt` on the encrypted message. The decrypted message is also
