...
1. To view LogSinkBuf statements: Launch Runtime (RTOS) Objects while in a debug session.
...
1. Run the program.
    ...
    In Runtime Objects, you will see the initial start up message, followed by a count
...
LogModule_App2 or LogModule_App3. Log modules are useful for grouping and
sorting log statements that share configurations such as severity levels and
...
* LogSinkBuf - all instances of LogSinkBuf. Each instances is a separate memory
