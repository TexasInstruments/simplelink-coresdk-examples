...
This example shows how to use the AESCCM driver. The target expects the user
...
It performs an encryption on a predefined message using `AESCCM_oneStepEncrypt`
and displays the encrypted message to the console. Then, it performs a decryption
using `AESCCM_oneStepDecrypt` on the encrypted message. Decrypted message is also
