...
This example shows how to use the AESECB driver. The target expects the user
...
It performs an encryption on a predefined message using `AESECB_oneStepEncrypt`
and displays the encrypted message to the console. Then, it performs a decryption
using `AESECB_oneStepDecrypt` on the encrypted message. Decrypted message is also
