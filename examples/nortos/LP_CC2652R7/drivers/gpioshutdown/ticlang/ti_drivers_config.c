...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by CONFIG_BUTTON_SHUTDOWN as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_BUTTON_SHUTDOWN_INPUT */
...
const uint_least8_t CONFIG_GPIO_BUTTON_SHUTDOWN_INPUT_CONST = CONFIG_GPIO_BUTTON_SHUTDOWN_INPUT;
...
static const Button_HWAttrs ButtonHWAttrs[CONFIG_BUTTON_COUNT] = {
    ...
    {
        .gpioIndex = CONFIG_GPIO_BUTTON_SHUTDOWN_INPUT,
...
const Button_Config Button_config[CONFIG_BUTTON_COUNT] = {
    ...
    /* LaunchPad Button BTN-1 (Left) */
    {
        .object = &ButtonObjects[CONFIG_BUTTON_SHUTDOWN],
        .hwAttrs = &ButtonHWAttrs[CONFIG_BUTTON_SHUTDOWN]
    },
};

const uint_least8_t CONFIG_BUTTON_SHUTDOWN_CONST = CONFIG_BUTTON_SHUTDOWN;
