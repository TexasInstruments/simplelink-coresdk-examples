...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by CONFIG_SD_0 as BOOSTXL-SHARP128 SD SPI Chip Select */
...
const SD_Config SD_config[CONFIG_SD_COUNT] = {
    ...
    /* BOOSTXL-SHARP128 SD Card */
    {
        ...
        .object = &SDSPI_objects[CONFIG_SD_0],
        .hwAttrs = &SDSPI_hwAttrs[CONFIG_SD_0]
    },
};

const uint_least8_t CONFIG_SD_0_CONST = CONFIG_SD_0;
