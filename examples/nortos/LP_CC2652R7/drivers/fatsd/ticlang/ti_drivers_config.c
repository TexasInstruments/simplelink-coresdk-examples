...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    /* Owned by CONFIG_SDFatFS_0 as BOOSTXL-SHARP128 SD SPI Chip Select */
...
SDFatFS_Object SDFatFS_objects[CONFIG_SD_FATFS_COUNT];

const SDFatFS_Config SDFatFS_config[CONFIG_SD_FATFS_COUNT] = {
    /* CONFIG_SDFatFS_0 */
    {
        .object = &SDFatFS_objects[CONFIG_SDFatFS_0]
    },
};

const uint_least8_t SDFatFS_count = CONFIG_SD_FATFS_COUNT;

SDSPI_Object SDSPI_objects[CONFIG_SD_COUNT];

static const SDSPI_HWAttrs SDSPI_hwAttrs[CONFIG_SD_COUNT] = {
    /* CONFIG_SDFatFS_0 */
...
const SD_Config SD_config[CONFIG_SD_COUNT] = {
    ...
    /* BOOSTXL-SHARP128 SD Card */
    {
        ...
        .object = &SDSPI_objects[CONFIG_SDFatFS_0],
        .hwAttrs = &SDSPI_hwAttrs[CONFIG_SDFatFS_0]
    },
};
