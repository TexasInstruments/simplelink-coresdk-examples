...
WatchdogLPF3_Object WatchdogLPF3_objects[CONFIG_WATCHDOG_COUNT];

const WatchdogLPF3_HWAttrs WatchdogLPF3_hwAttrs[CONFIG_WATCHDOG_COUNT] = {
...
const Watchdog_Config Watchdog_config[CONFIG_WATCHDOG_COUNT] = {
    /* CONFIG_WATCHDOG_0 */
    {
        ...
        .object      = &WatchdogLPF3_objects[CONFIG_WATCHDOG_0],
        .hwAttrs     = &WatchdogLPF3_hwAttrs[CONFIG_WATCHDOG_0]
    }
};
